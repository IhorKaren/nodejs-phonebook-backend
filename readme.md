...
- ##### PATCH /auth/subscription - Change user subscription
...
 
- ##### GET /contacts/{contactId} - Get user contact by ID
...
 
- ##### PATCH /{contactId}/favorite - Add or remove a contact from favorites
...
- ##### GET /verify/{verificationCode} - Verify by email (After successful registration, user will receive an email with a link to the following URL)
-  ###### Responses: 200 Email has been successfully verified. 404 Not found. 500 Server error.
 
- ##### POST /verify - Resend the verification link to email
